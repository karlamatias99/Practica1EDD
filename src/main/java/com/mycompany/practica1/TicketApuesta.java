...
public class TicketApuesta {
    ...
    public TicketApuesta(String primera, String segunda, String tercera, String cuarta, String quinta, String sexta, String septima, String octava, String novena, String decima) {
    ...
    /**
     * @param tercera the tercera to set
     */
    ...
    /**
     * @param cuarta the cuarta to set
     */
    ...
    /**
     * @param septima the septima to set
     */
    ...
    /**
     * @param novena the novena to set
     */
    ...
    /**
     * @param decima the decima to set
     */
